                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><?php print isset($arrData['nombre']) ? utf8_decode($arrData['nombre']) : 'Nuevo usuario'; ?></li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group has-feedback" id="txtNombreGrupo">
                                        ...
                                        <div class="col-lg-5">
                                            <input type="text" name="txtNombre" id="txtNombre" value="<?php print isset($arrData['nombre']) ? utf8_decode($arrData['nombre']) : ''; ?>" class="form-control input-sm" autofocus="autofocus" maxlength="75" required="required" aria-describedby="txtNombreEstado">
